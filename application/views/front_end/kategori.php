...
<?php foreach ($current_kategori->result() as $key) {?> 
			<div class="current-page">
				<a href="<?php echo base_url();?>"><i class="fa fa-home"></i> <i class="fa fa-angle-double-right"></i></a> <a href="<?php echo base_url();?>front_end/kategori/<?php echo $key->id_kategori ?>"><?php echo $key->nama_kategori ?></a>
			</div> <?php } ?> <!-- / .current-page -->
			<section id="ccr-category-1">
					<ul class="ccr-category-post">
						<?php foreach ($news_kategori->result() as $key) {?> 
						<li>
