        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
					...
					Berita
					<a href="<?php echo base_url("reporter/add_news"); ?>">
                                    ...
                                    <tbody>
                                       <?php foreach ($news->result() as $key) {?>	
										<tr>
											...
											<td class="center">
												<a href="<?php echo base_url("reporter/update_news/".$key->id_news); ?>">
													<button type="button" class="btn btn-success">Edit</button>
												</a>
												<a href="<?php echo base_url("reporter/delete_news/".$key->id_news); ?>">
