...
(function(q,r,m){
    var s={required:"%s harus diisi.",
           matches:"The %s field does not match the %s field.","default":"The %s field is still set to default, please change.",
           valid_email:"%s harus berisi format email valid.",
           valid_emails:"%s harus berisi format email valid.",
           min_length:"%s harus memiliki panjang minimal %s karakter.",
           max_length:"%s harus memiliki panjang maksimal %s karakter.",
